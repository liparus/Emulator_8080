...
// 	5. Advance the pointer the number of bytes used
// 	   by that instruction (1, 2, or 3 bytes).
 ...
 *
 * The code below assumes the instruction was one byte,
 * but the 2 and 3 byte instructions change the value
 * of the "opbytes" variable so an accurate instruction
 * size is returned.
 */
